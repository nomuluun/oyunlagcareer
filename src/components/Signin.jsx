      ...
      <div className="bg-[#F5F4F9] h-dvh flex justify-center items-center">
        <div className="grid grid-cols-12 gap-4 max-w-[1200px] w-full items-center">
          <div className="col-span-7">
            ...
            <img className=" w-full max-w-[600px]" src="svg/Saly-34.png" alt="" />
          </div>
          <div className="relative col-span-5">
            <button className="font-bold absolute -right-10 -top-[140px] text-[#5E17EB] text-[20px]">
              Шинээр бүртгүүлэх
            </button>
            <h3 className="font-bold text-[24px] text-[#373737] absolute -top-[80px] -left-[40px]">Нэвтрэх</h3>
